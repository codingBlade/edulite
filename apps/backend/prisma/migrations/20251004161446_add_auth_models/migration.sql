...
-- CreateIndex
CREATE UNIQUE INDEX "Notification_achievementId_key" ON "Notification"("achievementId");
...
-- AddForeignKey
ALTER TABLE "Achievement" ADD CONSTRAINT "Achievement_subjectId_fkey" FOREIGN KEY ("subjectId") REFERENCES "Subject"("id") ON DELETE SET NULL ON UPDATE CASCADE;
